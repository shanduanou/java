...
import com.pubnub.publish.dependencies.specific.PNPublishResult
...
class Publish internal constructor(
    pubnub: PubNub, //publishService, 	-RetrofitManager  -PNConfiguration -MapperManager -PublishSequenceManager
    val message: Any,
    val channel: String,
    val meta: Any? = null,
