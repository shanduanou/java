...
import com.pubnub.publish.dependencies.FileEncryptionUtil.decrypt
import com.pubnub.publish.dependencies.FileEncryptionUtil.encrypt
import com.pubnub.publish.dependencies.forPubNubObject.*
import com.pubnub.publish.dependencies.java.Base64
...
class PubNub(val configuration: PNConfiguration) {
    ...
    fun decrypt(inputString: String, cipherKey: String = configuration.cipherKey): String =
        Crypto(
            cipherKey,
            configuration.useRandomInitializationVector
        ).decrypt(inputString, Base64.DEFAULT)
    ...
    fun encrypt(inputString: String, cipherKey: String = configuration.cipherKey): String =
        Crypto(
            cipherKey,
            configuration.useRandomInitializationVector
        ).encrypt(inputString, Base64.DEFAULT)
