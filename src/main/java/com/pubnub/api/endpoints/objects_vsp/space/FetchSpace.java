...
public class FetchSpace extends ObjectApiEndpoint<EntityEnvelope<Space>, Space> implements HavingCustomInclude<FetchSpace> {
    ...
    public static FetchSpace create(
        ...
        return new FetchSpace(spaceId, pubNub, telemetryManager, retrofitManager, tokenManager, compositeParameterEnricher);
    }
