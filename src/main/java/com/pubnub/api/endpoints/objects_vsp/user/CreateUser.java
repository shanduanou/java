...
public abstract class CreateUser extends ObjectApiEndpoint<EntityEnvelope<User>, User> implements CustomIncludeAware<CreateUser> {
    ...
    public static CreateUser create(
        ...
        return new CreateUserCommand(userId, pubNub, telemetryManager, retrofitManager, tokenManager, compositeParameterEnricher);
    }
