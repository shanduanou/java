...
public abstract class FetchUser extends UserEndpoint<FetchUser, EntityEnvelope<User>, FetchUserResult> implements CustomIncludeAware<FetchUser> {
    ...
    public static FetchUser create(final PubNub pubNub,
