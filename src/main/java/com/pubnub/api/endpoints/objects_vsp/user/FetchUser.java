...
public abstract class FetchUser extends ObjectApiEndpoint<EntityEnvelope<User>, User> implements CustomIncludeAware<FetchUser> {
    ...
    public static FetchUser create(
        ...
        return new FetchUserCommand(userId, pubNub, telemetryManager, retrofitManager, tokenManager, compositeParameterEnricher);
